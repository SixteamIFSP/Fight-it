    ...
    return (
        <View style={stylesGlobal.container}>
            ...
            <View style={styles.userTypeChoice}>
                <Text>{translation('createAccount.descriptionSwitch')}</Text>
            </View>
            ...
            <Input
                ...
                value={name}
                placeholder={translation('createAccount.name')}
            />
            <Input
                style={styles.inputes}
            ...
            <Input
                ...
                value={phone}
                placeholder={translation('createAccount.phone')}
            />
            <Input
                style={styles.inputes}
            ...
            <Input
                ...
                value={confirm}
                placeholder={translation('createAccount.confirmPassword')}
                secureTextEntry={true}
            />
